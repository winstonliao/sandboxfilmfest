...
class WatchSection extends Component {
  constructor() {
    ...
    this.year2021 = React.createRef()
    this.year2020 = React.createRef()
  ...
  yearHandler(year) {
    const index = Array.from(this.carousel.current.props.children).findIndex(
      film => film.props.year === year
    )
    this.setState(state => ({
      year: year,
    }))
    ReactDOM.findDOMNode(this.filmRefs[index].current).scrollIntoView({
      behavior: "smooth",
      block: "nearest",
      inline: "start",
    })
    ...
    if (inView) {
      ...
      const endIndex =
        ...
        films
          .slice()
          .reverse()
          .findIndex(film => film.year === year) -
        1

      this.setState(state => ({
        percent:
          100 * ((index - startIndex + 1) / (endIndex - startIndex + 1)) + "%",
      ...
      <StyledWatchSection id={this.props.id}>
        <SplitLayout
          left={
            <div className="title-wrapper">
              <span>WATCH</span>
              <Year
                selected={this.state.year === 2021}
                year={2021}
                ref={this.year2021}
                percent={this.state.percent}
                onClick={() => this.yearHandler(2021)}
              ></Year>
              <Year
                selected={this.state.year === 2020}
                year={2020}
                ref={this.year2020}
                percent={this.state.percent}
                onClick={() => this.yearHandler(2020)}
              ></Year>
              <Year
                selected={this.state.year === 2019}
                year={2019}
                ref={this.year2019}
                percent={this.state.percent}
                onClick={() => this.yearHandler(2019)}
              ></Year>
              <Year
                selected={this.state.year === 2018}
                year={2018}
                ref={this.year2018}
                percent={this.state.percent}
                onClick={() => this.yearHandler(2018)}
              ></Year>
            </div>
          }
          right={
              ...
              <Carousel ref={this.carousel} isLight={true}>
                {films.map((film, i) => (
                  <Visibility
                    ...
                    index={i}
                    year={film.year}
                    root={this.state.container}
                    threshold={0.99}
                    onChange={this.visibilityHandler}
                  >
                    <FilmItem
                      {...film}
                      onClick={() => this.modalHandler(film)}
                    ></FilmItem>
                  </Visibility>
                ))}
              </Carousel>
        ...
        >
          {this.state.showModal && (
            <LightBox ref={this.lightBox} {...this.state.film}></LightBox>
          )}
        </Modal>
      </StyledWatchSection>
    )
...
const films = [
  {
    title: "My Crazy Roommate: Wizard Edition",
    image: "../images/wizard.png",
    year: 2021,
    video: "https://www.youtube.com/embed/z56uHyeZK88",
    logline:
      "On this week's episode of \"My Crazy Roommate\", Lilli shares what it's really like to live with a wizard.",
    awards: [
      "Audience Choice",
      "Best Actor",
      "Best Actress",
    ...
    actors: ["Lilli Carlsen", "Michael Lin"],
    prompts: {
      image: "Boo from Monsters Inc. in a monster costume",
      song: "Therefore I Am by Billie Eilish",
    },
  },
  {
    title: "Snowblind",
    image: "../images/snowblind.png",
    year: 2021,
    video: "https://www.youtube.com/embed/LIHZZ6qSNIE",
    logline:
      "A woman wakes up in a different dimension controlled by an evil soul-sucking robot, and has to find her way home.",
    awards: ["Free Solo"],
    creators: ["Deedee Anderson"],
    actors: ["Deedee Anderson, Bryce Taylor"],
    prompts: {
      image: "Illustration of a boy and tigers walking through the jungle",
      quote:
  ...
  },
  {
    ...
    year: 2021,
    video: "https://www.youtube.com/embed/WKyRWyDjZTs",
    logline: "A misanthrope tries to escape from the ambient noise of life",
    awards: ["Free Solo"],
    creators: ["Nina Zubrilina"],
    actors: ["Nina Zubrilina"],
    prompts: {
      quote: '"Do not let the hero in your soul perish"',
      song: "Lost Cause by Black Pistol Fire",
    },
  },
  {
    title: "Submission 2",
    image: "../images/submission2.png",
    year: 2021,
    video: "https://www.youtube.com/embed/pDo-HJUspqI",
    logline: "Second submission, fated date.",
    creators: [
      "Colin Kalicki",
      "Brandon Jaimes",
      "Ayush Pandit",
    ...
    actors: ["Asia Zhang", "Brandon Jaimes"],
    prompts: {
      quote:
        '"We don’t do lollipops and rainbows because we know those are pretty colors that just hide what the world really is. Black and white." - Angela Abar',
      song: "Painting of a man and woman connected by a key",
    },
  },
  {
    title: "FAN BOYS",
    image: "../images/fanboys.png",
    year: 2021,
    video: "https://www.youtube.com/embed/fYS-2TE7nnw",
    logline: "WHEN LIFE FAILS THE INTERNET PREVAILS. GO BIG OR GO HOME TRYING",
    creators: ["Liam Hankin", "Scott Nakano", "Jon Maccnnama"],
    actors: ["Scott Nakano"],
    prompts: {
      quote:
        "\"It's fall, fuckfaces. You're either ready to reap this freaky-assed harvest or you're not.\" - Collin Nissan",
      song: "11H30 by Danger",
    },
  },
  {
    title: "Ze Beans",
    image: "../images/zebeans.png",
    year: 2021,
    video: "https://www.youtube.com/embed/7ceN9E7SrLk",
    logline: "What's in the box?",
    creators: ["Robert Muni", "Winston Liao"],
    actors: ["Katiana Uyemura", "Kiko Ilagan"],
    prompts: {
      image: "Houseplant",
      song: "Canopée by Polo & Pan",
    },
  },
  {
    ...
    logline:
      "A millennial generously agrees to be part of a new show on the Discovery Channel",
  ...
  },
  {
    ...
    logline:
      "A King tormented, not by what he has built, but by what he cannot bring with him",
  ...
  },
  {
    ...
    prompts: {
      ...
      quote:
        '"You have the right to work, but for the work\'s sake only. You have no right to the fruits of work. Desire for the fruits of work must never be your motive in working. Never give way to laziness, either." -\xa0Bhagavad Gita',
  ...
  },
  {
    ...
    logline:
      "A cutthroat 80's stockbroker is taught a valuable lesson that he'll never forget",
  ...
  },
  {
    ...
    logline:
      "Two friends with dysfunctional communication adventure for a day in a strange, post-apocalyptic world",
    awards: ["Best Actress", "Best Use of Prompts"],
    creators: [
      "Jack Virnich",
      "Alli Armstrong",
    ...
    prompts: {
      ...
      autocomplete:
        "Hey you can do that it sounds good but I think you can get a lot more fun at this point and I am sure it will if she is the only person I know about it yet lol",
    },
  },
  {
    title: "Firestruck",
  ...
  },
  {
    ...
    year: 2018,
    video:
      "https://drive.google.com/file/d/1kSgCHSsbFF76yzZxZh89ZN4A4WrI9lO6/preview",
  ...
  },
  {
    ...
    prompts: {
      ...
      autocomplete:
        "I will be there in the morning to see if you want to come by and see you soon to catch up on the phone with my mom and sister are you free to talk today or tomorrow to get the kids",
    },
  },
]
